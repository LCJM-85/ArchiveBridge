  ...
  <div class="page-wrapper">
    ...
    <div class="page-hero">
      <div class="ph-left">
        ...
        <h2 class="font-display">毕业数据管理</h2>
        <div class="ph-rule"></div>
        <p class="ph-sub">毕业档案与去向的录入、查询与维护 · 覆盖学士/硕士/博士</p>
      </div>
      <div class="ph-right">
        <div class="ph-count">
        ...
        <svg class="ph-art" viewBox="0 0 220 90" preserveAspectRatio="xMidYMax meet">
          ...
          <g transform="translate(164 30)">
            <path d="M0 -14 L22 -20 L44 -14 L22 -8 Z" fill="#d9b877"/>
            <path d="M44 -14 L44 0" stroke="#d9b877" stroke-width="2.2" stroke-linecap="round"/>
            <circle cx="44" cy="3" r="3.4" fill="#2fb984"/>
            <path d="M-4 -12 L-4 -2" stroke="rgba(230,205,149,.5)" stroke-width="1.4" stroke-linecap="round"/>
          </g>
          <!-- 去向柱状 -->
          <g>
            <rect x="16" y="52" width="13" height="24" rx="3" fill="#0e8a5f"/>
            <rect x="36" y="40" width="13" height="36" rx="3" fill="#14a06f"/>
            <rect x="56" y="30" width="13" height="46" rx="3" fill="#2fb984"/>
            <rect x="76" y="20" width="13" height="56" rx="3" fill="#57c493"/>
          </g>
          <path d="M106 66 C 130 58, 150 46, 196 34" fill="none" stroke="#d9b877" stroke-width="2.2" stroke-linecap="round" stroke-dasharray="5 5"/>
          <circle cx="196" cy="34" r="3.4" fill="#d9b877"/>
          <circle cx="46" cy="18" r="2" fill="rgba(230,205,149,.5)"/>
        </svg>
      </div>
    </div>
    ...
    <div class="filter-bar">
      <el-select v-model="degreeFilter" placeholder="学历" clearable style="width:132px" @change="handleSearch">
    ...
    <el-card shadow="never" class="table-card">
      <el-table :data="tableData" v-loading="loading" stripe border style="width:100%">
        ...
        <el-table-column prop="graduationDate" label="毕业日期" width="110" align="center">
          <template #default="{ row }">
            <span class="date-num">{{ row.graduationDate || '-' }}</span>
          </template>
        </el-table-column>
...
.date-num { font-variant-numeric: tabular-nums; }
