...
export const useMetaDataStore = defineStore('metadata', () => {
  ...
  async function fetchPage() {
    ...
    try {
      ...
      const res = await request.get('/metadata/page', { params })
  ...
  async function add(data) {
    const res = await request.post('/metadata/add', data)
    return res.data
  }

  async function update(data) {
    const res = await request.put('/metadata/update', data)
    return res.data
  }

  async function remove(fieldCode) {
    const res = await request.delete('/metadata/delete', { params: { fieldCode } })
    return res.data
  }
